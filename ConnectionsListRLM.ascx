<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ConnectionsListRLM.ascx.cs" Inherits="com.reallifeministries.ConnectionsList" %>
            ...
            <div class="panel-body">
                ...
                <div class="grid grid-panel">
                    <Rock:GridFilter ID="rFilter" runat="server" OnDisplayFilterValue="rFilter_DisplayFilterValue">
                        ...
                        <Rock:RockCheckBoxList ID="cblRegion" runat="server" Label="Within Region" RepeatDirection="Horizontal" />
                    </Rock:GridFilter>
                    <Rock:Grid ID="gRequests" runat="server" OnRowSelected="gRequests_Edit" CssClass="js-grid-requests" AllowSorting="true" >
                        <Columns>
                            ...
                            <Rock:RockBoundField DataField="PhoneNumber" HeaderText="Phone" />
                            <Rock:RockBoundField DataField="PersonCity" HeaderText="City" SortExpression="PersonCity" />
                            <Rock:RockBoundField DataField="PersonState" HeaderText="State/Prov" SortExpression="PersonState"/>
                            <Rock:RockBoundField DataField="RegionName" HeaderText="Region" SortExpression="RegionName" />
                            <Rock:RockBoundField DataField="GroupName" HeaderText="Group" SortExpression="GroupName" />
                            <Rock:RockBoundField DataField="ConnectorName" HeaderText="Connector" SortExpression="ConnectorName" />

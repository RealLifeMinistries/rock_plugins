...
namespace com.reallifeministries.Search
{
    [DisplayName( "Person Birthday Search" )]
    [Category( "CRM" )]
    ...
    public partial class PersonBirthdaySearch : Rock.Web.UI.RockBlock
    {
        #region Fields
        ...
        void gPeople_RowDataBound( object sender, GridViewRowEventArgs e )
        {
            ...
            {
                var person = e.Row.DataItem as PersonBirthdaySearchResult;
                if ( person != null )
                {
        ...
        private void BindGrid()
        {
            ...
            DateTime birthday;
            if (DateTime.TryParse(term, out birthday))
            {
                people = personService.Queryable().Where(p => p.BirthDate == birthday);
                ...
                var personList = people.Select(p => new PersonBirthdaySearchResult
                {
                    Id = p.Id,
    ...
    public class PersonBirthdaySearchResult
    {
        /// <summary>
        /// Gets or sets the id.
        /// </summary>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RLMConnectionOpportunities.ascx.cs" Inherits="RockWeb.Blocks.Connection.RLMConnectionOpportunities" %>
                ...
                <div class="grid grid-panel">
                    ...
                    <Rock:Grid ID="gRequests" runat="server" OnRowSelected="gRequests_Edit" CssClass="js-grid-requests" AllowSorting="true" >
                        <Columns>
                            ...
                            <Rock:RockBoundField DataField="Comments" HeaderText="Comments" />
                            <Rock:RockBoundField DataField="CreatedDateTime" HeaderText="Created Date" SortExpression="CreatedDateTime" />

...
namespace com.reallifeministries.Attendance
{
    ...
    /// </summary>
    [DisplayName( "RLM Attendance Analytics" )]
    [Category( "Analytics" )]
...
";
        ...
        protected string getGroupId()
        {
            ...
            {
                _groupId = groupId.AsInteger();//, PageParameter("ParentGroupId").AsIntegerOrNull());
            }
        ...
        private void BindAttendeesGrid()
        {
            ...
            getGroupId();
            var groupType = new GroupService(rockContext).Get(_groupId).GroupType;

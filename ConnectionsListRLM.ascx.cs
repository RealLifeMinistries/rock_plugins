...
namespace com.reallifeministries
{
    ...
    /// </summary>
    [DisplayName( "Connection Requests List (RLM)" )]
    [Category( "Connection" )]
    ...
    [GroupTypeField("Geofence Group Type", "Filterable Groups to geofence people")]
    ...
    public partial class ConnectionsList : Rock.Web.UI.RockBlock
    {
...
";
        ...
        protected void rFilter_ApplyFilterClick( object sender, EventArgs e )
        {
            ...
            rFilter.SaveUserPreference( "Region", "Region", cblRegion.SelectedValues.AsDelimited( ";" ) );
        ...
        protected void rFilter_DisplayFilterValue( object sender, GridFilter.DisplayFilterValueArgs e )
        {
            using ( var rockContext = new RockContext() )
            {
                ...
                {
                    e.Value = ResolveValues( e.Value, cblRegion );
                }
        ...
        private void SetFilter()
        {
            using ( var rockContext = new RockContext() )
            {
                ...
                if (SelectedOpportunityId.HasValue && groupTypeGuid != null)
                {
                    ...
                    cblRegion.Items.Add( new ListItem( "No Region", "0" ) );
                    foreach (GroupLocation location in groupLocations)
                    {
                        cblRegion.Items.Add( new ListItem( location.Location.Name, location.LocationId.ToString() ) );
                    }
                    cblRegion.SetValues( rFilter.GetUserPreference( "Region" ).SplitDelimitedValues().AsIntegerList() );

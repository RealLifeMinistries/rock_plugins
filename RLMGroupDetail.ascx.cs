...
namespace com.reallifeministries
{
    ...
    public partial class RLMGroupDetail : RockBlock, IDetailBlock
    {
        #region Constants
        ...
        protected override void LoadViewState( object savedState )
        {
            ...
            if (GroupLocationsState != null) {
                lpGroupLocation.Text = GroupLocationsState.First().ToString();
            }
        ...
        private void ShowReadonlyDetails( Group group )
        {
            ...
            var groupLocations = group.GroupLocations.FirstOrDefault();
            if (groupLocations != null)
            {
                lMeetingDetails.Text = groupLocations.Location.ToString();
                lMeetingDetails.Visible = true;
            }            
